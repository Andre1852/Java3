...
public class ExecutorServiceExample {
    ...
    ExecutorServiceExample() {
        ...
        CountDownLatch cdl1 = new CountDownLatch(COUNT);//счетчик с нижним замком
        ...
        executor.execute(new MyThread(cdl1, "Thread.1"));//execute выполняет данную команду в какой-то момент в будущем.
